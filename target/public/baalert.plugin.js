...
/******/ 		return __webpack_require__.p + "baalert.chunk." + chunkId + ".js"
/******/ 	}
/******/
...
/******/
/******/ 	var jsonpArray = window["baalert_bundle_jsonpfunction"] = window["baalert_bundle_jsonpfunction"] || [];
...
__webpack_require__.p = window.__kbnPublicPath__['baalert']
...
const PLUGIN_ID = 'baalert';
const PLUGIN_NAME = 'baalert';
...
switch (window.__kbnThemeTag__) {
  case 'v7dark':
    console.error(new Error("SASS files in [baalert] were not built for theme [v7dark]. Styles were compiled using the [v8dark] theme instead to keep Kibana somewhat usable. Please adjust the advanced settings to make use of [v8dark,v8light] or make sure the KBN_OPTIMIZER_THEMES environment variable includes [v7dark] in a comma separated list of themes you want to compile. You can also set it to \"*\" to build all themes."));
    return __webpack_require__(/*! ./index.scss?v8dark */ "./public/index.scss?v8dark")

  case 'v7light':
    console.error(new Error("SASS files in [baalert] were not built for theme [v7light]. Styles were compiled using the [v8light] theme instead to keep Kibana somewhat usable. Please adjust the advanced settings to make use of [v8dark,v8light] or make sure the KBN_OPTIMIZER_THEMES environment variable includes [v7light] in a comma separated list of themes you want to compile. You can also set it to \"*\" to build all themes."));
...
/*!*************************!*\
  !*** ./public/index.ts ***!
  \*************************/
/*! exports provided: plugin, BaalertPluginSetup, BaalertPluginStart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BaalertPluginSetup", function() { return _types__WEBPACK_IMPORTED_MODULE_2__["BaalertPluginSetup"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BaalertPluginStart", function() { return _types__WEBPACK_IMPORTED_MODULE_2__["BaalertPluginStart"]; });
...
function plugin() {
  return new _plugin__WEBPACK_IMPORTED_MODULE_1__["BaalertPlugin"]();
}
...
/*!**************************!*\
  !*** ./public/plugin.ts ***!
  \**************************/
/*! exports provided: BaalertPlugin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BaalertPlugin", function() { return BaalertPlugin; });
...
class BaalertPlugin {
  setup(core) {
    ...
    return {
      getGreeting() {
        return _kbn_i18n__WEBPACK_IMPORTED_MODULE_0__["i18n"].translate('baalert.greetingText', {
...
/******/ });
//# sourceMappingURL=baalert.plugin.js.map